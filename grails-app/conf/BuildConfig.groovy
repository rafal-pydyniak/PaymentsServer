...
grails.project.dependency.resolution = {
    ...
    plugins {
        ...
        //compile ":spring-security-oauth2-provider:1.0.5.2" - powoduje błędy!
        compile ":browser-detection:0.4.3"

        compile ":spring-security-rest:1.5.2", {
            excludes 'spring-security-core'
        } //REST Stateless Plugin

        //Rest api docs (and plugins that are required by rest api docs to work properly)
